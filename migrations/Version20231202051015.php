 ...
 */
final class Version20231202051015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, type_vehicule_id INT DEFAULT NULL, ville_id INT NOT NULL, utilisateur_id INT NOT NULL, marque VARCHAR(255) NOT NULL, modele VARCHAR(255) NOT NULL, comune VARCHAR(255) DEFAULT NULL, nb_places INT NOT NULL, telephone VARCHAR(255) NOT NULL, whatsapp VARCHAR(255) DEFAULT NULL, avec_chauffeur TINYINT(1) NOT NULL, chauffeur_obligatoire TINYINT(1) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_F65593E5153E280 (type_vehicule_id), INDEX IDX_F65593E5A73F0036 (ville_id), INDEX IDX_F65593E5FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE orange_popsicle (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, plain_password VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) NOT NULL, whatsapp VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE orange_popsicle');
